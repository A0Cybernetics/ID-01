...
menuOption neokeyColorSlowOption {
  1,
  neokeyColorSlowOptionText,
  neokeyColorSlowOptionSelect,
};

String neokeyColorSlowOptionText() {
  return ((String) "LED Cycle Slow : " + neokeyColorSlow + "         ");
}

void neokeyColorSlowOptionSelect() {
  incNeokeyColorSlow();
  drawMenuOptionSelected(menuOptionSelected);
}
