...
uint8_t neokeySwirlColor = 0;          // tracks the colors of the LEDs color cycle for swirl
...
const uint8_t but1DebounceDelay = 59;
const uint8_t but2DebounceDelay = 59;
const uint16_t but1HoldDelay = 599;
const uint16_t but2HoldDelay = 599;
unsigned long but1LastDebounceTime = 0;
unsigned long but2LastDebounceTime = 0;
unsigned long but1LastHoldTime = 0;
unsigned long but2LastHoldTime = 0;
bool but1HoldFlag = 0;
bool but2HoldFlag = 0;
